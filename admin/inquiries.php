    ...
    <section class="home-section">
        ...
        <div class="second-box">
            ...
            <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php 
                                    $query = "SELECT * FROM inquiry_form";
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $booking)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="inquiries-view.php?id=<?= $booking['id']; ?>" class="btn btn-info btn-sm">View</a>
                                                    <form action="run.php" method="POST" class="d-inline">
                                                        <button type="submit" name="delete_inquiries" value="<?=$booking['id'];?>" class="btn btn-danger btn-sm">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php
